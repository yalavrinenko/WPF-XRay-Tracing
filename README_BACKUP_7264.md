...
=======
0. Изменено API для написания графической оболочки. Совершен переход из Python GTK на WPF.NET. Это позволяет боле комфортно поддерживать 
код и добавлять в него новые возможности.
>>>>>>> 70b35157df651cc2b1eb1b5ea49da92ab51ce014
