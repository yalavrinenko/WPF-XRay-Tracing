...
tPlane::tPlane(Vec3d N, Vec3d _r0, std::string const &logpath) :
    tPlane(N, _r0, 0, 0, logpath) {
}

tPlane::tPlane(Vec3d N, Vec3d _r0, double _lim_area, std::string const &logpath) :
    tPlane(N, _r0, _lim_area, _lim_area, logpath) {
}

tPlane::tPlane(Vec3d N, Vec3d _r0, double _lim_area_w, double _lim_area_h, std::string const &dumpName) :
